...
const Header = ({ onClickOpen, fullPrice }) => {
  return (
    <>
      <header>
        ...
        <ul className="header__rigth">
          <li onClick={() => onClickOpen()} style={{ cursor: "pointer" }}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
            ...
            {fullPrice != 0 ? <span>{fullPrice} руб.</span> : ""}
          </li>
          <li>
            <NavLink to="/markspage">
              <svg
          ...
          <NavLink to="/purchasespage">
            <li>
              <img src="/img/Union.svg" style={{ cursor: "pointer" }} />
            </li>
          </NavLink>
        </ul>
      </header>
